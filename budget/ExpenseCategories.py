...
'''
    ...
    print(timeit.timeit(stmt="expenses.categorize_for_loop()", number=100000,globals=globals(), setup=setup))
    print(timeit.timeit(stmt="expenses.categorize_set_comprehension()", number=100000,globals=globals(), setup=setup))
